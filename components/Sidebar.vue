<template>
  <div class="fixed w-full">
    <aside
      ...
      class="fixed top-0 left-0 z-40 w-64 h-screen border-r border-cyan-500 border-opacity-20 transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div
        class="h-full px-3 h-screen flex-col flex justify-between py-4 overflow-y-auto"
        :class="{
          'bg-gray-100 border-cyan-800': !isDarkMode,
          'bg-gray-800 border-white': isDarkMode,
        }"
      >
        <ul class="space-y-2 font-medium">
          ...
          <li class="">
            <NuxtLink
              to="/"
              :class="{
                'dark:text-white': isDarkMode && $route.path === '/',
                'text-gray-900': !isDarkMode || $route.path !== '/',
                'dark:text-white': isDarkMode && $route.path === '/',
                'text-white': !isDarkMode && $route.path === '/',
                'dark:hover:bg-gray-700': isDarkMode,
                'hover:bg-gray-100': !isDarkMode,
                'dark:border-l-sky-500': $route.path === '/' && isDarkMode,
                'border-l-sky-500': $route.path === '/' && !isDarkMode,
          ...
          <li>
            <NuxtLink
              to="/Employes"
              :class="{
                'dark:text-white': isDarkMode && $route.path === '/Employes',
                'text-gray-900': !isDarkMode || $route.path !== '/Employes',
                'dark:text-white': isDarkMode && $route.path === '/Employes',
                'text-white': !isDarkMode && $route.path === '/Employes',
                'dark:hover:bg-gray-700': isDarkMode,
                'hover:bg-gray-100': !isDarkMode,
                'dark:border-l-sky-500':
                  $route.path === '/Employes' && isDarkMode,
                'border-l-sky-500': $route.path === '/Employes' && !isDarkMode,
                'bg-gradient-to-r from-sky-600 to-cyan-400':
                  $route.path === '/Employes',
              }"
              class="flex items-center rounded-xl p-2 mb-5 group"
          ...
          <li>
            <NuxtLink
              to="/Absence"
              :class="{
                'dark:text-white': isDarkMode && $route.path === '/Absence',
                'text-gray-900': !isDarkMode || $route.path !== '/Absence',
                'dark:text-white': isDarkMode && $route.path === '/Absence',
                'text-white': !isDarkMode && $route.path === '/Absence',
                'dark:hover:bg-gray-700': isDarkMode,
                'hover:bg-gray-100': !isDarkMode,
                'dark:border-l-sky-500':
                  $route.path === '/Absence' && isDarkMode,
                'border-l-sky-500': $route.path === '/Absence' && !isDarkMode,
                'bg-gradient-to-r from-sky-600 to-cyan-400':
                  $route.path === '/Absence',
              }"
              class="flex items-center rounded-xl p-2 mb-5 group"
          ...
          <li>
            <NuxtLink
              to="/retards"
              :class="{
                'dark:text-white': isDarkMode && $route.path === '/retards',
                'text-gray-900':
                  (!isDarkMode || $route.path !== '/retards') &&
                  $route.path !== '/retards',
                'dark:text-white': isDarkMode && $route.path === '/retards',
                'text-white': !isDarkMode && $route.path === '/retards',
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  <g>
                    <g>
                      <path
                        d="M295.391,0h-78.783c-5.443,0-8.706,4.322-8.706,9.76v39.391c0,5.438,3.263,9.935,8.706,9.935h78.783 c5.443,0,10.99-4.497,10.99-9.935V9.76C306.381,4.322,300.835,0,295.391,0z M286.686,39.391h-59.087V19.696h59.087V39.391z"
                      ></path>
                    </g>
                  </g>
                  <g>
                  ...
                  <g>
                    <g>
                      <path
                        d="M317.472,243.223l-13.926-13.926l-30.561,30.564c-5.15-2.477-10.898-3.906-16.986-3.906 c-21.725,0-39.391,17.671-39.391,39.391c0,6.087,1.428,11.834,3.902,16.985l-30.561,30.566l13.926,13.926l29.373-29.377 c6.431,4.573,14.272,7.291,22.751,7.291c21.725,0,39.391-17.671,39.391-39.391c0-8.476-2.717-16.315-7.29-22.75L317.472,243.223z M256,315.043c-10.857,0-19.696-8.833-19.696-19.696c0-10.863,8.838-19.696,19.696-19.696c10.858,0,19.696,8.833,19.696,19.696 C275.696,306.21,266.858,315.043,256,315.043z"
                      ></path>
                    </g>
                  </g>
                </g>
          ...
          <li>
            <NuxtLink
              to="/conges"
              :class="{
                'dark:text-white': isDarkMode && $route.path === '/conges',
                'text-gray-900':
                  (!isDarkMode || $route.path !== '/conges') &&
                  $route.path !== '/conges',
                'dark:text-white': isDarkMode && $route.path === '/conges',
                'text-white': !isDarkMode && $route.path === '/conges',
                'dark:border-l-sky-500 border-l-sky-500':
                  $route.path === '/conges',
                'bg-gradient-to-r from-sky-600 to-cyan-400':
                  $route.path === '/conges',
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium dark:border-gray-700">
          <li>
            <NuxtLink
              to="/users"
              :class="{
                'dark:text-white': isDarkMode && $route.path === '/users',
                'text-gray-900':
                  (!isDarkMode || $route.path !== '/users') &&
                  $route.path !== '/users',
                'dark:text-white': isDarkMode && $route.path === '/users',
                'text-white': !isDarkMode && $route.path === '/users',
                'dark:border-l-sky-500 border-l-sky-500':
                  $route.path === '/users',
                'bg-gradient-to-r from-sky-600 to-cyan-400':
                  $route.path === '/users',
          ...
          <li>
            <button
              ...
              :class="{
                'dark:text-white': isDarkMode && $route.path !== '',
                'text-gray-900': !isDarkMode || $route.path === '',
                'dark:hover:bg-gray-700 hover:bg-gray-100': true,
                'dark:border-l-sky-500 border-l-sky-500': $route.path !== '',
                'bg-gradient-to-r from-sky-600 to-cyan-400': $route.path !== '',
                'flex items-center rounded-xl p-2 mb-5 group': true,
              }"
            >
              <svg
    ...
    <nav
      id="nav"
      class="sm:ml-64 border-b border-cyan-500 border-opacity-20"
    ...
    >
      <div
        ...
        :class="{
          'bg-gray-800 border-white ': isDarkMode,
          'bg-gray-100 border-gray-800': !isDarkMode,
        }"
      >
        <div>
          <button
            ...
            type="button"
            class="inline-flex items-center ms-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          >
            <span v-if="showSpans" class="sr-only">Open sidebar</span>
            <svg
              class="w-6 h-6"
              aria-hidden="true"
              fill="currentColor"
        ...
        <div
          class="dark-mode-toggle flex justify-between items-center"
          @click="$nuxt.$emit('toggleDarkMode')"
        >
...
<script>
import cardDashbord from "./cardDashbord.vue";
